...
public class StockPriceController {
	...
	public ResponseEntity<List<StockPriceDetailsDTO>> deleteStockByCompanyCode(@PathVariable Long companyCode) {
		return new ResponseEntity<>(stockMarketService.deleteStock(companyCode), HttpStatus.OK);
	}

	// -------------------------------------------------------------------------------------------------------------------------------
	@GetMapping(value = "/getAllStock") // 4. WORKING
	public ResponseEntity<List<StockPriceDetailsDTO>> getAllStock() {
		return new ResponseEntity<>(stockMarketService.getAllStock(), HttpStatus.OK);
	}
	...
	public ResponseEntity<List<StockPriceDetailsDTO>> getStockByCompanyCode(@PathVariable Long companyCode) {
		return new ResponseEntity<>(stockMarketService.getStockByCode(companyCode), HttpStatus.OK);
	}
	...
	public ResponseEntity<StockPriceIndexDTO> displayStockPriceIndex(@PathVariable Long companyCode,
		...
		return new ResponseEntity<>(stockMarketService.getStockPriceIndex(companyCode, sDate, eDate), HttpStatus.OK);
	}
